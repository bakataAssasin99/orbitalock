object Form1: TForm1
  ...
  Caption = 'proRFL.DLL Demo  (MSN: hp28168371@126.com)'
  ClientHeight = 668
  ClientWidth = 848
  Color = clBtnFace
  ...
  object GroupBox3: TGroupBox
    ...
    object Label2: TLabel
      ...
      AutoSize = False
      Caption = 
        '1, The USB Reader must be initialized before you operate it or c' +
        'ards'
      Font.Charset = GB2312_CHARSET
      Font.Color = clBlue
      Font.Height = -16
    ...
    object Label4: TLabel
      ...
      AutoSize = False
      Caption = 
        '2, Guest Dai is used to overwrite function, for example, the Dai' +
        ' of first card is 5, and the Dai of second card  is 3, the first' +
        ' card would not  unlock the door lock after the second card unlo' +
        'cked the door lock, we call it with Overwrite'
      Font.Charset = GB2312_CHARSET
      Font.Color = clBlue
      Font.Height = -16
      Font.Name = 'System'
  ...
  object BitBtn11: TBitBtn
    ...
    Width = 217
    Height = 33
    Caption = 'Get unlock door record'
    TabOrder = 11
